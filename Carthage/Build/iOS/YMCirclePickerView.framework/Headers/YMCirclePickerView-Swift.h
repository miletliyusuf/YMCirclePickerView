...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="YMCirclePickerView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18YMCirclePickerView18YMCirclePickerView")
@interface YMCirclePickerView : UIView
...
@interface YMCirclePickerView (SWIFT_EXTENSION(YMCirclePickerView)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UICollectionViewCell;

@interface YMCirclePickerView (SWIFT_EXTENSION(YMCirclePickerView)) <UICollectionViewDataSource>
...
@interface YMCirclePickerView (SWIFT_EXTENSION(YMCirclePickerView)) <UIScrollViewDelegate>
...
SWIFT_CLASS("_TtC18YMCirclePickerView24YMCirclePickerViewLayout")
@interface YMCirclePickerViewLayout : UICollectionViewFlowLayout
